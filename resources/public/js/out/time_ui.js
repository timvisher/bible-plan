...
time_ui.weekdays = new cljs.core.PersistentArrayMap(null, 7, ["Monday",cljs.core.constant$keyword$150,"Tuesday",cljs.core.constant$keyword$151,"Wednesday",cljs.core.constant$keyword$152,"Thursday",cljs.core.constant$keyword$153,"Friday",cljs.core.constant$keyword$154,"Saturday",cljs.core.constant$keyword$155,"Sunday",cljs.core.constant$keyword$156], null);
...
time_ui.inc_date_by_day = (function inc_date_by_day(date){var G__13289 = date.clone();G__13289.add((new goog.date.Interval(0,0,1)));
return G__13289;
});
time_ui.dec_date_by_day = (function dec_date_by_day(date){var G__13291 = date.clone();G__13291.add((new goog.date.Interval(0,0,-1)));
return G__13291;
});
time_ui.inc_date_by_year = (function inc_date_by_year(date){var G__13293 = date.clone();G__13293.add((new goog.date.Interval(1)));
return G__13293;
});
...
time_ui.__GT_td = (function __GT_td(date){var long_date_formatter = (new goog.i18n.DateTimeFormat(goog.i18n.DateTimeFormat.Format.LONG_DATE));var now = date;var formatted_now = long_date_formatter.format(date);var dom13295 = document.createElement("td");dom13295.appendChild(dommy.template.__GT_node_like(time_ui.date__GT_long_format(date)));
return dom13295;
});
time_ui.days_of_week = new cljs.core.PersistentArrayMap(null, 7, [cljs.core.constant$keyword$156,0,cljs.core.constant$keyword$150,1,cljs.core.constant$keyword$151,2,cljs.core.constant$keyword$152,3,cljs.core.constant$keyword$153,4,cljs.core.constant$keyword$154,5,cljs.core.constant$keyword$155,6], null);
...
{return cljs.core.some(cljs.core.identity,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13296_SHARP_){return cljs.core.partial.cljs$core$IFn$_invoke$arity$2(time_ui.day_is,p1__13296_SHARP_);
