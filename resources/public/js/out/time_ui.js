...
time_ui.inc_date_by_day = (function inc_date_by_day(date){var G__18860 = date.clone();G__18860.add((new goog.date.Interval(0,0,1)));
return G__18860;
});
time_ui.dec_date_by_day = (function dec_date_by_day(date){var G__18862 = date.clone();G__18862.add((new goog.date.Interval(0,0,-1)));
return G__18862;
});
time_ui.inc_date_by_year = (function inc_date_by_year(date){var G__18864 = date.clone();G__18864.add((new goog.date.Interval(1)));
return G__18864;
});
...
{return cljs.core.some(cljs.core.identity,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18867_SHARP_){return cljs.core.partial.cljs$core$IFn$_invoke$arity$2(time_ui.day_is,p1__18867_SHARP_);
