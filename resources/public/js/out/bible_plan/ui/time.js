...
bible_plan.ui.time.__GT_td = (function __GT_td(date){var dom9343 = document.createElement("td");dom9343.appendChild(dommy.template.__GT_node_like(bible_plan.ui.time.date__GT_long_format(date)));
return dom9343;
});
