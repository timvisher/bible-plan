...
bible_plan.ui.time.__GT_td = (function __GT_td(date){var dom9512 = document.createElement("td");dom9512.appendChild(dommy.template.__GT_node_like(bible_plan.ui.time.date__GT_long_format(date)));
return dom9512;
});
