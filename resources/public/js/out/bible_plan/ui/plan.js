...
bible_plan.ui.plan.days_of_week = new cljs.core.PersistentArrayMap(null, 7, ["monday",1,"tuesday",2,"wednesday",3,"thursday",4,"friday",5,"saturday",6,"sunday",7], null);
...
,dommy.utils.__GT_Array(document.querySelectorAll(dommy.core.selector(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1("input[name=skip-day]:checked"))))));var start_date = bible_plan.ui.plan.start_date();var end_date = bible_plan.ui.plan.end_date();var books_at_a_time_QMARK__node = document.querySelector(dommy.core.selector(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1("input[name=books-at-a-time]:checked")));var books_at_a_time_QMARK__raw = (cljs.core.truth_(books_at_a_time_QMARK__node)?books_at_a_time_QMARK__node.value:null);var books_at_a_time_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("yes",books_at_a_time_QMARK__raw);var plan_options = new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$157,base_plan,cljs.core.constant$keyword$154,skip_days,cljs.core.constant$keyword$156,start_date,cljs.core.constant$keyword$155,end_date,cljs.core.constant$keyword$153,books_at_a_time_QMARK_], null);shodan.console.log.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([plan_options], 0))], 0));
return plan_options;
});
bible_plan.ui.plan.plan_day__GT_tr = (function plan_day__GT_tr(p__13225){var map__13228 = p__13225;var map__13228__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_(map__13228))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13228):map__13228);var plan_day = map__13228__$1;var date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13228__$1,cljs.core.constant$keyword$159);var readings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13228__$1,cljs.core.constant$keyword$158);var dom13229 = document.createElement("tr");dom13229.appendChild(dommy.template.__GT_node_like(time_ui.__GT_td(date)));
dom13229.appendChild(dommy.template.__GT_node_like(cljs.core.map.cljs$core$IFn$_invoke$arity$2(bible_plan.ui.reference.__GT_td,readings)));
return dom13229;
});
