...
goog.require('shodan.console');
goog.require('dommy.core');
bible_plan.ui.plan.hide_plan = (function hide_plan(){return (dommy.core.add_class_BANG_.cljs$core$IFn$_invoke$arity$2 ? dommy.core.add_class_BANG_.cljs$core$IFn$_invoke$arity$2(document.getElementById("plan"),cljs.core.constant$keyword$171) : dommy.core.add_class_BANG_.call(null,document.getElementById("plan"),cljs.core.constant$keyword$171));
});
...
return (dommy.core.remove_class_BANG_.cljs$core$IFn$_invoke$arity$2 ? dommy.core.remove_class_BANG_.cljs$core$IFn$_invoke$arity$2(document.getElementById("plan"),cljs.core.constant$keyword$171) : dommy.core.remove_class_BANG_.call(null,document.getElementById("plan"),cljs.core.constant$keyword$171));
});
...
{var plan_options = bible_plan.ui.plan.plan_state__GT_plan_options();var the_plan = bible_plan.plan.calculate_plan(plan_options);var plan_dom_content = cljs.core.constant$keyword$162.cljs$core$IFn$_invoke$arity$1(bible_plan.export$.core.exporters).call(null,the_plan);return bible_plan.ui.plan.show_plan_BANG_(plan_dom_content);
} else
{return null;
}
});
