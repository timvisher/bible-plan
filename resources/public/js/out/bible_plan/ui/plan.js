...
goog.require('shodan.console');
goog.require('dommy.core');
bible_plan.ui.plan.hide_plan = (function hide_plan(){return (dommy.core.add_class_BANG_.cljs$core$IFn$_invoke$arity$2 ? dommy.core.add_class_BANG_.cljs$core$IFn$_invoke$arity$2(document.getElementById("plan"),cljs.core.constant$keyword$178) : dommy.core.add_class_BANG_.call(null,document.getElementById("plan"),cljs.core.constant$keyword$178));
});
...
return (dommy.core.remove_class_BANG_.cljs$core$IFn$_invoke$arity$2 ? dommy.core.remove_class_BANG_.cljs$core$IFn$_invoke$arity$2(document.getElementById("plan"),cljs.core.constant$keyword$178) : dommy.core.remove_class_BANG_.call(null,document.getElementById("plan"),cljs.core.constant$keyword$178));
});
...
{return clj_time.core.plus.cljs$core$IFn$_invoke$arity$2((clj_time.core.now.cljs$core$IFn$_invoke$arity$0 ? clj_time.core.now.cljs$core$IFn$_invoke$arity$0() : clj_time.core.now.call(null)),clj_time.core.days(1));
}
});
...
return (function day_input__GT_keyword(day_input){return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(day_input.value);
});})(base_plan))
,dommy.utils.__GT_Array(document.querySelectorAll(dommy.core.selector(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1("input[name=skip-day]:checked"))))));var start_date = bible_plan.ui.plan.start_date();var end_date = bible_plan.ui.plan.end_date();var books_at_a_time_QMARK__node = document.querySelector(dommy.core.selector(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1("input[name=books-at-a-time]:checked")));var books_at_a_time_QMARK__raw = (cljs.core.truth_(books_at_a_time_QMARK__node)?books_at_a_time_QMARK__node.value:null);var books_at_a_time_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("yes",books_at_a_time_QMARK__raw);var plan_options = new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$164,base_plan,cljs.core.constant$keyword$161,skip_days,cljs.core.constant$keyword$163,start_date,cljs.core.constant$keyword$162,end_date,cljs.core.constant$keyword$160,books_at_a_time_QMARK_], null);shodan.console.log.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([plan_options], 0))], 0));
return plan_options;
});
bible_plan.ui.plan.plan_day__GT_tr = (function plan_day__GT_tr(p__18941){var map__18944 = p__18941;var map__18944__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_(map__18944))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__18944):map__18944);var plan_day = map__18944__$1;var date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18944__$1,cljs.core.constant$keyword$166);var readings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18944__$1,cljs.core.constant$keyword$165);var dom18945 = document.createElement("tr");dom18945.appendChild(dommy.template.__GT_node_like(time_ui.__GT_td(date)));
dom18945.appendChild(dommy.template.__GT_node_like(cljs.core.map.cljs$core$IFn$_invoke$arity$2(bible_plan.ui.reference.__GT_td,readings)));
return dom18945;
});
