...
{{
var G__9935 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9935;
continue;
}
} else
...
{var pred__9939 = cljs.core._EQ_;var expr__9940 = limit;if(cljs.core.truth_(pred__9939.call(null,1,expr__9940)))
...
var G__9942 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9943 = (limit__$1 - 1);
var G__9944 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9942;
limit__$1 = G__9943;
parts = G__9944;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___9946 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___9946))
{var replacement_9947 = temp__4090__auto___9946;buffer.append([cljs.core.str(replacement_9947)].join(''));
} else
{buffer.append(ch);
}
{
