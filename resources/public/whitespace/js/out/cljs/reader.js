...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj10204 = {};return obj10204;
})();
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__3830__auto__,writer__3831__auto__,opt__3832__auto__){return cljs.core._write.call(null,writer__3831__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.number_literal_QMARK_ = (function number_literal_QMARK_(reader,initch){var or__3291__auto__ = cljs.reader.numeric_QMARK_.call(null,initch);if(cljs.core.truth_(or__3291__auto__))
{return or__3291__auto__;
} else
...
reader_error.cljs$lang$applyTo = (function (arglist__10205){
var rdr = cljs.core.first(arglist__10205);
var msg = cljs.core.rest(arglist__10205);
...
{var or__3291__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(cljs.core.truth_(or__3291__auto____$1))
{return or__3291__auto____$1;
} else
...
{{
var G__10206 = (function (){sb.append(ch);
return sb;
})();
var G__10207 = cljs.reader.read_char.call(null,rdr);
sb = G__10206;
ch = G__10207;
continue;
}
...
{if(cljs.core.truth_(cljs.reader.numeric_QMARK_.call(null,ch)))
...
{{
var G__10208 = cljs.reader.read_char.call(null,rdr);
ch = G__10208;
continue;
}
} else
...
var G__10209 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__10209;
continue;
}
} else
...
var G__10210 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__10210;
continue;
}
}
...
{{
var G__10211 = (function (){buffer.append(ch);
return buffer;
})();
var G__10212 = cljs.reader.read_char.call(null,reader);
buffer = G__10211;
ch = G__10212;
continue;
}
...
{if(("\\" === ch))
{{
var G__10213 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__10214 = cljs.reader.read_char.call(null,reader);
buffer = G__10213;
ch = G__10214;
continue;
}
...
{{
var G__10215 = (function (){buffer.append(ch);
return buffer;
})();
var G__10216 = cljs.reader.read_char.call(null,reader);
buffer = G__10215;
ch = G__10216;
continue;
}
...
cljs.reader.read_meta = (function read_meta(rdr,_){var m = cljs.reader.desugar_meta.call(null,cljs.reader.read.call(null,rdr,true,null,true));if(cljs.core.truth_(cljs.core.map_QMARK_.call(null,m)))
{} else
{cljs.reader.reader_error.call(null,rdr,"Metadata must be Symbol,Keyword,String or Map");
}
var o = cljs.reader.read.call(null,rdr,true,null,true);if(cljs.core.truth_((function (){var G__10218 = o;if(G__10218)
{var bit__3912__auto__ = (G__10218.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__3912__auto__) || (G__10218.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__10218.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__10218);
} else
{return false;
}
}
...
{if(cljs.core.truth_(cljs.reader.whitespace_QMARK_.call(null,ch)))
{{
var G__10219 = reader;
var G__10220 = eof_is_error;
var G__10221 = sentinel;
var G__10222 = is_recursive;
reader = G__10219;
eof_is_error = G__10220;
sentinel = G__10221;
is_recursive = G__10222;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__10223 = cljs.reader.read_comment.call(null,reader,ch);
var G__10224 = eof_is_error;
var G__10225 = sentinel;
var G__10226 = is_recursive;
reader = G__10223;
eof_is_error = G__10224;
sentinel = G__10225;
is_recursive = G__10226;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{var f = cljs.reader.macros.call(null,ch);var res = (cljs.core.truth_(f)?f.call(null,reader,ch):(cljs.core.truth_(cljs.reader.number_literal_QMARK_.call(null,reader,ch))?cljs.reader.read_number.call(null,reader,ch):((new cljs.core.Keyword(null,"else","else",1017020587))?cljs.reader.read_symbol.call(null,reader,ch):null)));if((res === reader))
{{
var G__10227 = reader;
var G__10228 = eof_is_error;
var G__10229 = sentinel;
var G__10230 = is_recursive;
reader = G__10227;
eof_is_error = G__10228;
sentinel = G__10229;
is_recursive = G__10230;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__10233 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__10233,0,null);var years = cljs.core.nth.call(null,vec__10233,1,null);var months = cljs.core.nth.call(null,vec__10233,2,null);var days = cljs.core.nth.call(null,vec__10233,3,null);var hours = cljs.core.nth.call(null,vec__10233,4,null);var minutes = cljs.core.nth.call(null,vec__10233,5,null);var seconds = cljs.core.nth.call(null,vec__10233,6,null);var fraction = cljs.core.nth.call(null,vec__10233,7,null);var offset_sign = cljs.core.nth.call(null,vec__10233,8,null);var offset_hours = cljs.core.nth.call(null,vec__10233,9,null);var offset_minutes = cljs.core.nth.call(null,vec__10233,10,null);var v = vec__10233;if(cljs.core.not.call(null,v))
...
{var vec__10235 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__10235,0,null);var months = cljs.core.nth.call(null,vec__10235,1,null);var days = cljs.core.nth.call(null,vec__10235,2,null);var hours = cljs.core.nth.call(null,vec__10235,3,null);var minutes = cljs.core.nth.call(null,vec__10235,4,null);var seconds = cljs.core.nth.call(null,vec__10235,5,null);var ms = cljs.core.nth.call(null,vec__10235,6,null);var offset = cljs.core.nth.call(null,vec__10235,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
...
cljs.reader.read_queue = (function read_queue(elems){if(cljs.core.truth_(cljs.core.vector_QMARK_.call(null,elems)))
