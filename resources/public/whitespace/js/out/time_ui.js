...
time_ui.inc_date_by_day = (function inc_date_by_day(date){var G__7636 = date.clone();G__7636.add((new goog.date.Interval(0,0,1)));
return G__7636;
});
time_ui.dec_date_by_day = (function dec_date_by_day(date){var G__7638 = date.clone();G__7638.add((new goog.date.Interval(0,0,-1)));
return G__7638;
});
time_ui.inc_date_by_year = (function inc_date_by_year(date){var G__7640 = date.clone();G__7640.add((new goog.date.Interval(1)));
return G__7640;
});
...
{return cljs.core.some.call(null,cljs.core.identity,cljs.core.apply.call(null,cljs.core.juxt,cljs.core.map.call(null,(function (p1__7643_SHARP_){return cljs.core.partial.call(null,time_ui.day_is,p1__7643_SHARP_);
