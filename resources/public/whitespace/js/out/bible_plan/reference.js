...
goog.require('bible_plan.verse_map');
goog.require('cljs.reader');
bible_plan.reference.__GT_verse_maps = (function __GT_verse_maps(reference){var map__5881 = reference;var map__5881__$1 = ((cljs.core.seq_QMARK_.call(null,map__5881))?cljs.core.apply.call(null,cljs.core.hash_map,map__5881):map__5881);var end = cljs.core.get.call(null,map__5881__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__5881__$1,new cljs.core.Keyword(null,"start","start",1123661780));var verse_maps = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [start], null);var verse_maps__$1 = (cljs.core.truth_(end)?cljs.core.conj.call(null,verse_maps,end):verse_maps);return verse_maps__$1;
});
/**
* @param {...*} var_args
*/
...
if(cljs.core.every_QMARK_.call(null,(function (p1__5882_SHARP_){return cljs.core.get_in.call(null,p1__5882_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"start","start",1123661780),new cljs.core.Keyword(null,"book","book",1016933979)], null));
}),references))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"every?","every?",1363110461,null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-1640430053,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__5882#","p1__5882#",-1529664546,null)], null),cljs.core.list(new cljs.core.Symbol(null,"get-in","get-in",1405049013,null),new cljs.core.Symbol(null,"p1__5882#","p1__5882#",-1529664546,null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"start","start",1123661780),new cljs.core.Keyword(null,"book","book",1016933979)], null))),new cljs.core.Symbol(null,"references","references",-255581119,null))))].join('')));
}
...
_LT_.cljs$lang$applyTo = (function (arglist__5883){
var reference = cljs.core.first(arglist__5883);
var references = cljs.core.rest(arglist__5883);
...
;
bible_plan.reference.reference_QMARK_ = (function reference_QMARK_(p__5884){var map__5886 = p__5884;var map__5886__$1 = ((cljs.core.seq_QMARK_.call(null,map__5886))?cljs.core.apply.call(null,cljs.core.hash_map,map__5886):map__5886);var reference = map__5886__$1;var end = cljs.core.get.call(null,map__5886__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__5886__$1,new cljs.core.Keyword(null,"start","start",1123661780));var and__3469__auto__ = bible_plan.verse_map.verse_map_QMARK_.call(null,start);if(cljs.core.truth_(and__3469__auto__))
{if(cljs.core.truth_(end))
{var and__3469__auto____$1 = bible_plan.verse_map.verse_map_QMARK_.call(null,end);if(cljs.core.truth_(and__3469__auto____$1))
...
bible_plan.reference.single__GT_str = (function single__GT_str(p__5887){var map__5889 = p__5887;var map__5889__$1 = ((cljs.core.seq_QMARK_.call(null,map__5889))?cljs.core.apply.call(null,cljs.core.hash_map,map__5889):map__5889);var reference = map__5889__$1;var start = cljs.core.get.call(null,map__5889__$1,new cljs.core.Keyword(null,"start","start",1123661780));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
...
bible_plan.reference.compound__GT_str = (function compound__GT_str(p__5890){var map__5894 = p__5890;var map__5894__$1 = ((cljs.core.seq_QMARK_.call(null,map__5894))?cljs.core.apply.call(null,cljs.core.hash_map,map__5894):map__5894);var reference = map__5894__$1;var end = cljs.core.get.call(null,map__5894__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__5894__$1,new cljs.core.Keyword(null,"start","start",1123661780));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"reference?","reference?",-255581171,null),new cljs.core.Symbol(null,"reference","reference",1729280260,null))))].join('')));
}
if(cljs.core.truth_(end))
...
var map__5895 = start;var map__5895__$1 = ((cljs.core.seq_QMARK_.call(null,map__5895))?cljs.core.apply.call(null,cljs.core.hash_map,map__5895):map__5895);var start_verse_map = map__5895__$1;var s_book = cljs.core.get.call(null,map__5895__$1,new cljs.core.Keyword(null,"book","book",1016933979));var s_chapter = cljs.core.get.call(null,map__5895__$1,new cljs.core.Keyword(null,"chapter","chapter",1752919999));var s_verse = cljs.core.get.call(null,map__5895__$1,new cljs.core.Keyword(null,"verse","verse",1126001831));var map__5896 = end;var map__5896__$1 = ((cljs.core.seq_QMARK_.call(null,map__5896))?cljs.core.apply.call(null,cljs.core.hash_map,map__5896):map__5896);var end_verse_map = map__5896__$1;var e_book = cljs.core.get.call(null,map__5896__$1,new cljs.core.Keyword(null,"book","book",1016933979));var e_chapter = cljs.core.get.call(null,map__5896__$1,new cljs.core.Keyword(null,"chapter","chapter",1752919999));var e_verse = cljs.core.get.call(null,map__5896__$1,new cljs.core.Keyword(null,"verse","verse",1126001831));var verse_string = [cljs.core.str(bible_plan.verse_map.__GT_book_chapter_QMARK__verse_QMARK__str.call(null,start_verse_map)),cljs.core.str("-")].join('');var lowest_unequal_specificity = bible_plan.verse_map.lowest_unequal_specificity.call(null,end_verse_map,start_verse_map);var shown_specificities = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.drop_while.call(null,((function (verse_string,lowest_unequal_specificity,map__5895,map__5895__$1,start_verse_map,s_book,s_chapter,s_verse,map__5896,map__5896__$1,end_verse_map,e_book,e_chapter,e_verse,map__5894,map__5894__$1,reference,end,start){
return (function (specificity){return bible_plan.verse_map.specificity_LT_.call(null,specificity,lowest_unequal_specificity);
});})(verse_string,lowest_unequal_specificity,map__5895,map__5895__$1,start_verse_map,s_book,s_chapter,s_verse,map__5896,map__5896__$1,end_verse_map,e_book,e_chapter,e_verse,map__5894,map__5894__$1,reference,end,start))
...
bible_plan.reference.__GT_str = (function __GT_str(p__5897){var map__5899 = p__5897;var map__5899__$1 = ((cljs.core.seq_QMARK_.call(null,map__5899))?cljs.core.apply.call(null,cljs.core.hash_map,map__5899):map__5899);var reference = map__5899__$1;var start_verse_map = cljs.core.get.call(null,map__5899__$1,new cljs.core.Keyword(null,"start","start",1123661780));var end_verse_map = cljs.core.get.call(null,map__5899__$1,new cljs.core.Keyword(null,"end","end",1014004813));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"reference?","reference?",-255581171,null),new cljs.core.Symbol(null,"reference","reference",1729280260,null))))].join('')));
}
...
var G__5905 = cljs.core.into.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [int_1], null),ints);var vec__5906 = G__5905;var this_int = cljs.core.nth.call(null,vec__5906,0,null);var next_ints = cljs.core.nthnext.call(null,vec__5906,1);var G__5905__$1 = G__5905;while(true){
var vec__5907 = G__5905__$1;var this_int__$1 = cljs.core.nth.call(null,vec__5907,0,null);var next_ints__$1 = cljs.core.nthnext.call(null,vec__5907,1);if(cljs.core.not.call(null,cljs.core.first.call(null,next_ints__$1)))
{return true;
} else
{if(cljs.core._EQ_.call(null,(1 + this_int__$1),cljs.core.first.call(null,next_ints__$1)))
{{
var G__5908 = next_ints__$1;
G__5905__$1 = G__5908;
continue;
}
} else
...
contiguous_ascending_ints_QMARK_.cljs$lang$applyTo = (function (arglist__5909){
var int_1 = cljs.core.first(arglist__5909);
var ints = cljs.core.rest(arglist__5909);
...
{var join_points = bible_plan.reference.join_points.call(null,references);return (cljs.core.every_QMARK_.call(null,((function (join_points){
return (function (join_point){var specificity = cljs.core.apply.call(null,bible_plan.verse_map.highest_common_verse_map_specificity,join_point);return bible_plan.verse_map.lower_specificities_equal_QMARK_.call(null,specificity,join_point);
});})(join_points))
,join_points)) && (cljs.core.every_QMARK_.call(null,((function (join_points){
return (function (join_point){var specificity = cljs.core.apply.call(null,bible_plan.verse_map.highest_common_verse_map_specificity,join_point);return cljs.core.apply.call(null,bible_plan.reference.contiguous_ascending_ints_QMARK_,cljs.core.map.call(null,specificity,join_point));
});})(join_points))
,join_points));
} else
{return null;
...
contiguous_QMARK_.cljs$lang$applyTo = (function (arglist__5910){
var references = cljs.core.seq(arglist__5910);
...
;
bible_plan.reference.reference_verse_map_range = (function reference_verse_map_range(p__5911){var map__5913 = p__5911;var map__5913__$1 = ((cljs.core.seq_QMARK_.call(null,map__5913))?cljs.core.apply.call(null,cljs.core.hash_map,map__5913):map__5913);var reference = map__5913__$1;var end = cljs.core.get.call(null,map__5913__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__5913__$1,new cljs.core.Keyword(null,"start","start",1123661780));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"reference?","reference?",-255581171,null),new cljs.core.Symbol(null,"reference","reference",1729280260,null))))].join('')));
}
if(cljs.core.truth_(end))
...
disjoint_refs_QMARK_.cljs$lang$applyTo = (function (arglist__5914){
var references = cljs.core.seq(arglist__5914);
