...
goog.require('shodan.console');
bible_plan.reference.__GT_verse_maps = (function __GT_verse_maps(reference){var map__22988 = reference;var map__22988__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__22988))?cljs.core.apply.call(null,cljs.core.hash_map,map__22988):map__22988);var end = cljs.core.get.call(null,map__22988__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__22988__$1,new cljs.core.Keyword(null,"start","start",1123661780));var verse_maps = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [start], null);var verse_maps__$1 = (cljs.core.truth_(end)?cljs.core.conj.call(null,verse_maps,end):verse_maps);return verse_maps__$1;
});
/**
* @param {...*} var_args
*/
...
if(cljs.core.truth_(cljs.core.every_QMARK_.call(null,(function (p1__22989_SHARP_){return cljs.core.get_in.call(null,p1__22989_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"start","start",1123661780),new cljs.core.Keyword(null,"book","book",1016933979)], null));
}),references)))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"every?","every?",1363110461,null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-1640430053,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__22989#","p1__22989#",1704952579,null)], null),cljs.core.list(new cljs.core.Symbol(null,"get-in","get-in",1405049013,null),new cljs.core.Symbol(null,"p1__22989#","p1__22989#",1704952579,null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"start","start",1123661780),new cljs.core.Keyword(null,"book","book",1016933979)], null))),new cljs.core.Symbol(null,"references","references",-255581119,null))))].join('')));
}
...
;
bible_plan.reference.reference_QMARK_ = (function reference_QMARK_(p__22991){var map__22993 = p__22991;var map__22993__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__22993))?cljs.core.apply.call(null,cljs.core.hash_map,map__22993):map__22993);var reference = map__22993__$1;var end = cljs.core.get.call(null,map__22993__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__22993__$1,new cljs.core.Keyword(null,"start","start",1123661780));var and__3279__auto__ = bible_plan.verse_map.verse_map_QMARK_.call(null,start);if(cljs.core.truth_(and__3279__auto__))
...
bible_plan.reference.single__GT_str = (function single__GT_str(p__22994){var map__22996 = p__22994;var map__22996__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__22996))?cljs.core.apply.call(null,cljs.core.hash_map,map__22996):map__22996);var reference = map__22996__$1;var start = cljs.core.get.call(null,map__22996__$1,new cljs.core.Keyword(null,"start","start",1123661780));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
...
bible_plan.reference.compound__GT_str = (function compound__GT_str(p__22997){var map__23001 = p__22997;var map__23001__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__23001))?cljs.core.apply.call(null,cljs.core.hash_map,map__23001):map__23001);var reference = map__23001__$1;var end = cljs.core.get.call(null,map__23001__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__23001__$1,new cljs.core.Keyword(null,"start","start",1123661780));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"reference?","reference?",-255581171,null),new cljs.core.Symbol(null,"reference","reference",1729280260,null))))].join('')));
}
if(cljs.core.truth_(end))
...
var map__23002 = start;var map__23002__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__23002))?cljs.core.apply.call(null,cljs.core.hash_map,map__23002):map__23002);var start_verse_map = map__23002__$1;var s_book = cljs.core.get.call(null,map__23002__$1,new cljs.core.Keyword(null,"book","book",1016933979));var s_chapter = cljs.core.get.call(null,map__23002__$1,new cljs.core.Keyword(null,"chapter","chapter",1752919999));var s_verse = cljs.core.get.call(null,map__23002__$1,new cljs.core.Keyword(null,"verse","verse",1126001831));var map__23003 = end;var map__23003__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__23003))?cljs.core.apply.call(null,cljs.core.hash_map,map__23003):map__23003);var end_verse_map = map__23003__$1;var e_book = cljs.core.get.call(null,map__23003__$1,new cljs.core.Keyword(null,"book","book",1016933979));var e_chapter = cljs.core.get.call(null,map__23003__$1,new cljs.core.Keyword(null,"chapter","chapter",1752919999));var e_verse = cljs.core.get.call(null,map__23003__$1,new cljs.core.Keyword(null,"verse","verse",1126001831));var verse_string = [cljs.core.str(bible_plan.verse_map.__GT_book_chapter_QMARK__verse_QMARK__str.call(null,start_verse_map)),cljs.core.str("-")].join('');var lowest_unequal_specificity = bible_plan.verse_map.lowest_unequal_specificity.call(null,end_verse_map,start_verse_map);var shown_specificities = cljs.core.apply.call(null,cljs.core.vector,cljs.core.drop_while.call(null,((function (verse_string,lowest_unequal_specificity){
...
bible_plan.reference.__GT_str = (function __GT_str(p__23004){var map__23006 = p__23004;var map__23006__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__23006))?cljs.core.apply.call(null,cljs.core.hash_map,map__23006):map__23006);var reference = map__23006__$1;var start_verse_map = cljs.core.get.call(null,map__23006__$1,new cljs.core.Keyword(null,"start","start",1123661780));var end_verse_map = cljs.core.get.call(null,map__23006__$1,new cljs.core.Keyword(null,"end","end",1014004813));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"reference?","reference?",-255581171,null),new cljs.core.Symbol(null,"reference","reference",1729280260,null))))].join('')));
}
...
var G__23012 = cljs.core.into.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [int_1], null),ints);var vec__23013 = G__23012;var this_int = cljs.core.nth.call(null,vec__23013,0,null);var next_ints = cljs.core.nthnext.call(null,vec__23013,1);var G__23012__$1 = G__23012;while(true){
var vec__23014 = G__23012__$1;var this_int__$1 = cljs.core.nth.call(null,vec__23014,0,null);var next_ints__$1 = cljs.core.nthnext.call(null,vec__23014,1);if(cljs.core.not.call(null,cljs.core.first.call(null,next_ints__$1)))
{return true;
} else
...
;
bible_plan.reference.reference_verse_map_range = (function reference_verse_map_range(p__23018){var map__23020 = p__23018;var map__23020__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__23020))?cljs.core.apply.call(null,cljs.core.hash_map,map__23020):map__23020);var reference = map__23020__$1;var end = cljs.core.get.call(null,map__23020__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__23020__$1,new cljs.core.Keyword(null,"start","start",1123661780));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"reference?","reference?",-255581171,null),new cljs.core.Symbol(null,"reference","reference",1729280260,null))))].join('')));
}
if(cljs.core.truth_(end))
