...
goog.require('shodan.console');
bible_plan.reference.__GT_verse_maps = (function __GT_verse_maps(reference){var map__7714 = reference;var map__7714__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__7714))?cljs.core.apply.call(null,cljs.core.hash_map,map__7714):map__7714);var end = cljs.core.get.call(null,map__7714__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__7714__$1,new cljs.core.Keyword(null,"start","start",1123661780));var verse_maps = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [start], null);var verse_maps__$1 = (cljs.core.truth_(end)?cljs.core.conj.call(null,verse_maps,end):verse_maps);return verse_maps__$1;
});
/**
* @param {...*} var_args
*/
...
if(cljs.core.truth_(cljs.core.every_QMARK_.call(null,(function (p1__7715_SHARP_){return cljs.core.get_in.call(null,p1__7715_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"start","start",1123661780),new cljs.core.Keyword(null,"book","book",1016933979)], null));
}),references)))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"every?","every?",1363110461,null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-1640430053,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__7715#","p1__7715#",-1527853929,null)], null),cljs.core.list(new cljs.core.Symbol(null,"get-in","get-in",1405049013,null),new cljs.core.Symbol(null,"p1__7715#","p1__7715#",-1527853929,null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"start","start",1123661780),new cljs.core.Keyword(null,"book","book",1016933979)], null))),new cljs.core.Symbol(null,"references","references",-255581119,null))))].join('')));
}
...
_LT_.cljs$lang$applyTo = (function (arglist__7716){
var reference = cljs.core.first(arglist__7716);
var references = cljs.core.rest(arglist__7716);
...
;
bible_plan.reference.reference_QMARK_ = (function reference_QMARK_(p__7717){var map__7719 = p__7717;var map__7719__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__7719))?cljs.core.apply.call(null,cljs.core.hash_map,map__7719):map__7719);var reference = map__7719__$1;var end = cljs.core.get.call(null,map__7719__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__7719__$1,new cljs.core.Keyword(null,"start","start",1123661780));var and__3279__auto__ = bible_plan.verse_map.verse_map_QMARK_.call(null,start);if(cljs.core.truth_(and__3279__auto__))
...
bible_plan.reference.single__GT_str = (function single__GT_str(p__7720){var map__7722 = p__7720;var map__7722__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__7722))?cljs.core.apply.call(null,cljs.core.hash_map,map__7722):map__7722);var reference = map__7722__$1;var start = cljs.core.get.call(null,map__7722__$1,new cljs.core.Keyword(null,"start","start",1123661780));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
...
bible_plan.reference.compound__GT_str = (function compound__GT_str(p__7723){var map__7727 = p__7723;var map__7727__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__7727))?cljs.core.apply.call(null,cljs.core.hash_map,map__7727):map__7727);var reference = map__7727__$1;var end = cljs.core.get.call(null,map__7727__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__7727__$1,new cljs.core.Keyword(null,"start","start",1123661780));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"reference?","reference?",-255581171,null),new cljs.core.Symbol(null,"reference","reference",1729280260,null))))].join('')));
}
if(cljs.core.truth_(end))
...
var map__7728 = start;var map__7728__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__7728))?cljs.core.apply.call(null,cljs.core.hash_map,map__7728):map__7728);var start_verse_map = map__7728__$1;var s_book = cljs.core.get.call(null,map__7728__$1,new cljs.core.Keyword(null,"book","book",1016933979));var s_chapter = cljs.core.get.call(null,map__7728__$1,new cljs.core.Keyword(null,"chapter","chapter",1752919999));var s_verse = cljs.core.get.call(null,map__7728__$1,new cljs.core.Keyword(null,"verse","verse",1126001831));var map__7729 = end;var map__7729__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__7729))?cljs.core.apply.call(null,cljs.core.hash_map,map__7729):map__7729);var end_verse_map = map__7729__$1;var e_book = cljs.core.get.call(null,map__7729__$1,new cljs.core.Keyword(null,"book","book",1016933979));var e_chapter = cljs.core.get.call(null,map__7729__$1,new cljs.core.Keyword(null,"chapter","chapter",1752919999));var e_verse = cljs.core.get.call(null,map__7729__$1,new cljs.core.Keyword(null,"verse","verse",1126001831));var verse_string = [cljs.core.str(bible_plan.verse_map.__GT_book_chapter_QMARK__verse_QMARK__str.call(null,start_verse_map)),cljs.core.str("-")].join('');var lowest_unequal_specificity = bible_plan.verse_map.lowest_unequal_specificity.call(null,end_verse_map,start_verse_map);var shown_specificities = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.drop_while.call(null,((function (verse_string,lowest_unequal_specificity){
...
bible_plan.reference.__GT_str = (function __GT_str(p__7730){var map__7732 = p__7730;var map__7732__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__7732))?cljs.core.apply.call(null,cljs.core.hash_map,map__7732):map__7732);var reference = map__7732__$1;var start_verse_map = cljs.core.get.call(null,map__7732__$1,new cljs.core.Keyword(null,"start","start",1123661780));var end_verse_map = cljs.core.get.call(null,map__7732__$1,new cljs.core.Keyword(null,"end","end",1014004813));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"reference?","reference?",-255581171,null),new cljs.core.Symbol(null,"reference","reference",1729280260,null))))].join('')));
}
...
var G__7738 = cljs.core.into.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [int_1], null),ints);var vec__7739 = G__7738;var this_int = cljs.core.nth.call(null,vec__7739,0,null);var next_ints = cljs.core.nthnext.call(null,vec__7739,1);var G__7738__$1 = G__7738;while(true){
var vec__7740 = G__7738__$1;var this_int__$1 = cljs.core.nth.call(null,vec__7740,0,null);var next_ints__$1 = cljs.core.nthnext.call(null,vec__7740,1);if(cljs.core.not.call(null,cljs.core.first.call(null,next_ints__$1)))
{return true;
} else
{if(cljs.core._EQ_.call(null,(1 + this_int__$1),cljs.core.first.call(null,next_ints__$1)))
{{
var G__7741 = next_ints__$1;
G__7738__$1 = G__7741;
continue;
}
} else
...
contiguous_ascending_ints_QMARK_.cljs$lang$applyTo = (function (arglist__7742){
var int_1 = cljs.core.first(arglist__7742);
var ints = cljs.core.rest(arglist__7742);
...
contiguous_QMARK_.cljs$lang$applyTo = (function (arglist__7743){
var references = cljs.core.seq(arglist__7743);
...
;
bible_plan.reference.reference_verse_map_range = (function reference_verse_map_range(p__7744){var map__7746 = p__7744;var map__7746__$1 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__7746))?cljs.core.apply.call(null,cljs.core.hash_map,map__7746):map__7746);var reference = map__7746__$1;var end = cljs.core.get.call(null,map__7746__$1,new cljs.core.Keyword(null,"end","end",1014004813));var start = cljs.core.get.call(null,map__7746__$1,new cljs.core.Keyword(null,"start","start",1123661780));if(cljs.core.truth_(bible_plan.reference.reference_QMARK_.call(null,reference)))
{} else
{throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"reference?","reference?",-255581171,null),new cljs.core.Symbol(null,"reference","reference",1729280260,null))))].join('')));
}
if(cljs.core.truth_(end))
...
disjoint_refs_QMARK_.cljs$lang$applyTo = (function (arglist__7747){
var references = cljs.core.seq(arglist__7747);
